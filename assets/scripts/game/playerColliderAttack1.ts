...
@ccclass
export default class playerColliderAttack1 extends cc.Component {
    ...
    hit(damgeScale: number, attackType: attackType) {
        ...
        audioManager.playAudio(audioName.swoosh1);
        ...
        for (let enemy of this.enemys) {
            ...
            //@ts-ignore
            enemy.getComponent(enemyScript[enemy.name]).playBeHitSound(audioName.slash1);
        }
